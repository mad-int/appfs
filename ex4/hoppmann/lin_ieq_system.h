 ...
 *
 * 2.0 3.0 5.0 4.0 8.0 -3.0 -6.0 0.0 -8.0 -10.0 0.0 0.0 1.0 1.0 1.0
 *
 */
...
extern int linIeqSys_put(LinIeqSys* linIeqSys, int row_i, int col_j, double a);

/** puts b at RHS of row i */
extern void linIeqSys_putRHS(LinIeqSys* linIeqSys, int row_i, double b);
